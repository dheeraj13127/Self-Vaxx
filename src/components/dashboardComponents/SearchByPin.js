...
import {searchByPincode} from '../../redux/actions/index'
...
function SearchByPin() {
  ...
  const pincodeData=useSelector(state=>state.pincodeData)
  ...
  const onFormSubmit=(e)=>{
    ...
    if(date===""||pincode===""){
      ...
      NotificationManager.error('Invalid Pincode', '', 2000);
    }
    else{
      const newDate=date.toString().split("-").reverse().join("-")
      dispatch(searchByPincode(pincode,newDate))
    }
      ...
      <div className="card cards card-body text-light" style={{background:"orange"}}>
        ...
        <div className="row mt-5">
          ...
          <div className="card bg-primary cards text-light p-3">
            ...
            <i className="fas fa-search-location" style={{fontSize:"35px"}}></i>
